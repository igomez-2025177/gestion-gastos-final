...
export class Negocio implements OnInit {
  ...
  // solo movimientos marcados como negocio
  private businessMovements(): Movement[] {
    return this.movementService.movements().filter((m) => m.isBusiness);
  }
  ...
  exportarPDF(): void {
    ...
    doc.text('Historial de movimientos de negocio', 14, 42);
